...
Square, but the Square has to be covered. It's not allowed to break the flagstones. The sides of flagstones should be parallel 
...
int main (){
    long long heigth, width, result;
    double size;
    cin >> heigth;
    cin >> width;
    cin >> size;
    result = ceil(heigth/size) * ceil(width/size);
    cout << result;
    return 0;
}