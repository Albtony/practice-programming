...
tiresome. Let's consider a word too long, if its length is strictly more than 10 characters. All too long words should be replaced with a 
...
the process of changing the words with abbreviations. At that all too long words should be replaced by the abbreviation and 
...
repeat for x times {
    if wordlength > 10 
        print(firstchar + wordlength + lastchar + endl)
    else
        print(word + endl)
}
*/
