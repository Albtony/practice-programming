/*
Source: https://leetcode.com/problems/seasonal-sales-analysis/
Diff: Medium
Dialect: SQL Server
...
WITH categorized AS (
    SELECT 
        ...
        CASE 
            ...
            WHEN MONTH(s.sale_date) >= '3' AND MONTH(s.sale_date) <= '5' THEN 'Spring'
            WHEN MONTH(s.sale_date) >= '6' AND MONTH(s.sale_date) <= '8' THEN 'Summer'
            ELSE 'Fall'
        END AS season,
        s.quantity, 
        s.price
